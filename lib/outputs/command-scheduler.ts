 ...
 * as long as nothing wrote colour and temperature to the same lamp. A Colour
 * Curve Light does: a coloured point puts a lamp into colour mode, and every later
